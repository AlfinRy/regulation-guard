        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center">
          ...
          <div className="flex flex-col items-start gap-6 p-8 lg:p-12">
            ...
            <h1 className="text-display text-balance">
              From contract to compliance report in minutes.
            </h1>
            <p className="text-body-lg text-text-secondary text-balance max-w-lg">
              Deploy 4 specialized AI agents to audit your legal standing against GDPR, OJK, PDPA, and ISO 27001. Document ingestion to risk mitigation, automated.
            </p>
          ...
          <div className="p-4 lg:p-8 relative bg-gradient-to-bl from-accent-blue/5 via-transparent to-accent-blue/5">
